...
export default function AddEvent() {
  ...
  let statusList = ["booked", "confirmed", "cancelled"].map((item, i) => {
    return <Radio value={item}>{item}</Radio>;
  });
  let typeList = ["checki-in", "check-out", "return"].map((item, i) => {
    return (
  ...
  let agentList = [
    { code: "01", name: "1st Avenue" },
    { code: "02", name: "ChaseEvans" },
    { code: "03", name: "Chestertons" },
    { code: "04", name: "Conran" },
    { code: "05", name: "Felicity J Lord" },
  ].map((item, i) => {
    return (
      <option key={i} value={item.code}>
        {item.code + " - " + item.name}
  ...
  return (
    <Sidebar>
      ...
      <Grid bg={useColorModeValue("white", "gray.700")} borderRadius="lg" p={8}>
        <HStack spacing="24px" mb={8}>
          <FormControl>
            <FormLabel htmlFor="inspector">Inspector</FormLabel>
            <Select id="inspector" placeholdr="Select the inspector">
              {inspectorList}
            </Select>
          </FormControl>

          <FormControl>
            <FormLabel htmlFor="type">Request Type</FormLabel>
            <Select id="type" placeholdr="Select the type">
              {typeList}
            </Select>
          </FormControl>
        </HStack>
        <HStack mb={8}>
          {/* <FormControl isRequired>
            <FormLabel htmlFor="summary">Title</FormLabel>
            <Input id="summary" placeholder="Title" />
          </FormControl> */}
          <FormControl isRequired>
          ...
          <FormControl isRequired>
            <FormLabel htmlFor="contact.mobileNo">Contact Mobile No</FormLabel>
            <Input id="contact.mobileNo" placeholder="Contact Mobile No" />
          </FormControl>
          <FormControl isRequired>
        ...
        <HStack mb={8}>
          <FormControl as="fieldset">
            ...
            <RadioGroup defaultValue="booked">
              <HStack spacing="24px">{statusList}</HStack>
            </RadioGroup>
            {/* <FormHelperText>Select only if you're a fan.</FormHelperText> */}
          </FormControl>

          <FormControl as="fieldset">
            <FormLabel as="legend">Agent Estate</FormLabel>
            <Select id="agent" placeholdr="Select the Agent">
              {agentList}
            </Select>
            {/* <FormHelperText>Select nly if you're a fan.</FormHelperText> */}
          </FormControl>
        </HStack>
      </Grid>
    </Sidebar>
